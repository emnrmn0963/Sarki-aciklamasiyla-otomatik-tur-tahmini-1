...
# Öncelikle işlemlerimize gerekli kütüphanelerin kurulumu işlemi ile başlıyoruz.
import pandas as pd
import numpy as np
...
# Ön İşleme (Pre-processing) işlemlerini gerçekleştiriyoruz.
...
# lemmatize edilmiş cümleleri bir csv dosyasına kaydedilmesi.
...
# Lemmatize ettiğimiz verilerimizi TF-IDF vektörleştirme işlemi için çağırıyoruz.
import pandas as pd
...
# Word2vec Vektörleştirme işlemini Steemmed edilmiş veriler üzerinden görelim.
import gensim
...
####
Elimizde bulunan veri seti ile keşifsel veri analizi ve zamana bağlı trend analizi gibi çeşitli işlemler yapabiliriz. 
Parametrelerimize bakarak çeşitli tahmin işlemleri gerçekleştirebiliriz.
